        ...
        <View style={{ flex: 1, }}>
            ...
            <View style={{ flex: 6.8, }}>
                <Image
                    ...
                    resizeMode="stretch"
                    source={require('../../assets/drawable-xxxhdpi/tutorialfront.jpeg')}
                />
            </View>
            <View style={{ flex: 1.6, alignItems: "center", backgroundColor: "#5e5e5e" }}>
                <ImageBackground
                    ...
                    <Text style={{ fontSize: 20, color: "#b6c9d9", }}>Front Photo</Text>
                </ImageBackground>
            </View>
        </View >
    )
